...
def crawl_the_soup(file_of_links='paintings/painting_dataset_2018.csv', save_folder='paintings/original_files/'):
    ...
    for i, row in df.iterrows():
        ...
        for image in images:
            ...
            try:
                ...
                print(row)
                f = open(save_folder + '{}_{}.png'.format(row['labels'].strip("'"), i), 'wb')
